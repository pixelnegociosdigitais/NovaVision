...
function LogLine({ line }: { line: string }) {
  ...
  return (
    <div className={cn(
      ...
      !isError && !isSuccess && !isInfo && 'text-white/80 bg-white/3 border-white/5'
    )}>
      <span className="text-white/60 mr-2">[{new Date().toLocaleTimeString('pt-BR')}]</span>
      {line}
    </div>
  );
}
          ...
          <div className="p-6 space-y-5">
            ...
            <div className="flex items-center justify-between p-4 bg-white/3 rounded-xl border border-white/5">
              <div>
                ...
                <p className="text-xs text-white/70 mt-0.5">Filtrar somente Microempreendedores</p>
              </div>
              <button
            ...
            <div className="flex gap-3 pt-2">
              <button
                onClick={handleReset}
                disabled={isRunning}
                className="flex-1 py-3 rounded-xl border border-white/10 text-white/80 font-display font-semibold text-sm hover:bg-white/5 hover:text-white transition-all flex items-center justify-center gap-2 disabled:opacity-40"
              >
          ...
          <div className="glass-panel rounded-3xl overflow-hidden flex-1">
            <div className="p-5 border-b border-white/5 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-sm text-white/80">etl.pipeline.log</span>
              </div>
              {isRunning && (
              ...
              >
                ...
                <div className="p-6 grid grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-brand-blue/5 border border-brand-blue/10 rounded-2xl">
                    ...
                    <p className="text-xs text-white/70 font-semibold uppercase tracking-wider mt-1">Buscados</p>
                  </div>
                  <div className="text-center p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
                    ...
                    <p className="text-xs text-white/70 font-semibold uppercase tracking-wider mt-1">Salvos</p>
                  </div>
                  <div className="text-center p-4 bg-red-500/5 border border-red-500/10 rounded-2xl">
                    ...
                    <p className="text-xs text-white/70 font-semibold uppercase tracking-wider mt-1">Erros</p>
                  </div>
                </div>
